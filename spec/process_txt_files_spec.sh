...
Describe 'process_txt_files.zsh'
  ...
  Describe 'Basic execution'
    It 'should execute without syntax errors'
      When run zsh -n "$SHELLSPEC_PROJECT_ROOT/process_txt_files.zsh"
      The status should be success
    End

    It 'should handle empty directory gracefully'
      When run zsh "$SHELLSPEC_PROJECT_ROOT/process_txt_files.zsh" "test_trigger"
      The status should be success
  ...
  Describe 'File content processing'
    ...
    It 'should handle empty content files'
      ...
      When run zsh "$SHELLSPEC_PROJECT_ROOT/process_txt_files.zsh" "solo"
    ...
    It 'should remove virtual_youtuber tag'
      ...
      When run zsh "$SHELLSPEC_PROJECT_ROOT/process_txt_files.zsh" "character"
    ...
    It 'should process multiple files'
      ...
      When run zsh "$SHELLSPEC_PROJECT_ROOT/process_txt_files.zsh" "prefix"
